...
namespace {
	...
	)
	{
		...
		flag |= aiProcess_PreTransformVertices;	// すべての頂点をワールド空間に変換
		flag |= aiProcess_CalcTangentSpace;	// タンジェントスペースの計算
		flag |= aiProcess_GenSmoothNormals;	// スムーズな法線の生成
